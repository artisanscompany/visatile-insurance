...
### Scope ActionCable Channels ([#1800](https://github.com/basecamp/fizzy/pull/1800))
```ruby
# Bad - broadcasts to ALL tenants!
stream_from "all_boards"

# Good - scoped by account
stream_for [current_account, "boards"]
```

React components should only subscribe to channels scoped to their account/user context.
